...
const MAHabilidades = () => {
  ...
  return (
    <div ref={ref} id="habilidades-autoavaliacao" className="scroll-mt-20 rounded-2xl bg-white dark:bg-slate-900 p-8 shadow-2xl space-y-8">
      ...
      {/* Para Refletir */}
      <div className="rounded-2xl bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-slate-800 dark:to-slate-800 border border-blue-200 dark:border-slate-700 p-6 shadow">
        <div className="flex items-start gap-4">
          <div className="w-11 h-11 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl flex items-center justify-center shadow-md flex-shrink-0">
            <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
            </svg>
          </div>
          <div className="space-y-2">
            <h3 className={`${titleFont.className} text-xl font-bold text-blue-700 dark:text-blue-300`}>
              Para Refletir
            </h3>
